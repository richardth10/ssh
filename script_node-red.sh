...
tgta18=18.6.0    # need armv6l latest from https://unofficial-builds.nodejs.org/download/release/
...
Options:
  ...
  --nodered-version if not set, the latest version is used - e.g. --nodered-version="3.0.0"
